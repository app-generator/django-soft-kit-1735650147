...
> [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-soft-kit-1735650147) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-soft-kit-1735650147.git
$ cd django-soft-kit-1735650147
```
